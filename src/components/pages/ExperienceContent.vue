<template>
    <section class="contents" id="experience">
        <h1>Projects</h1>
        <section class="gallery">
            ...
            <figure>
                <img src="../../assets/bpo.png" alt="bpo">
                <figcaption>
            ...
            <figure>
                <img src="../../assets/market-place.png" alt="market">
                <figcaption>
                    <h3>Website development for market place demo</h3>
                    <p>
                        -Developed a website for market place
                    </p>
                    <p>
                        Tool: HTML, CSS, PHP, Vue.js, MySQL, Git
                    </p>
                </figcaption>
            </figure>
            <figure>
                <img src="../../assets/Libraweb.png" alt="libraweb">
                <figcaption>
                    <h3>Website development for a library demo</h3>
                    <p>
                        -Developed a website for a library
                    </p>
                    <p>
